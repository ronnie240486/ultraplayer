...
public final class C1796C extends RadioButton implements InterfaceC0171t {

    /* JADX INFO: renamed from: g */
    public final C1751d f7990g;

    /* JADX INFO: renamed from: h */
    public final C0687s f7991h;

    /* JADX INFO: renamed from: i */
    public final C1837X f7992i;

    /* JADX INFO: renamed from: j */
    public C1897v f7993j;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1796C(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, R.attr.radioButtonStyle);
        AbstractC1828S0.m4339a(context);
        AbstractC1826R0.m4334a(this, getContext());
        C1751d c1751d = new C1751d(this);
        this.f7990g = c1751d;
        c1751d.m4207d(attributeSet, R.attr.radioButtonStyle);
        C0687s c0687s = new C0687s(this);
        this.f7991h = c0687s;
        c0687s.m1804f(attributeSet, R.attr.radioButtonStyle);
        C1837X c1837x = new C1837X(this);
        this.f7992i = c1837x;
        c1837x.m4354f(attributeSet, R.attr.radioButtonStyle);
        getEmojiTextViewHelper().m4412a(attributeSet, R.attr.radioButtonStyle);
    }

    private C1897v getEmojiTextViewHelper() {
        if (this.f7993j == null) {
            this.f7993j = new C1897v(this);
        }
        return this.f7993j;
    }
    ...
    public final void drawableStateChanged() {
        ...
        C0687s c0687s = this.f7991h;
        if (c0687s != null) {
            c0687s.m1800b();
        }
        C1837X c1837x = this.f7992i;
        if (c1837x != null) {
            c1837x.m4351b();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f7992i.m4352d();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f7992i.m4353e();
    }
