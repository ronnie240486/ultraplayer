...
public final class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle state) {
        ...
        // Fundo da JANELA em si (não da View): sem isso, qualquer pedacinho
        // de tela ainda não coberto pela WebView/root (ex.: área de recorte
        // de câmera, ou o primeiro frame antes do layout terminar) mostra o
        // cinza padrão do tema (#212121) em vez da cor do app.
        getWindow().setBackgroundDrawable(new android.graphics.drawable.ColorDrawable(android.graphics.Color.rgb(11, 15, 26)));
        getWindow().setSoftInputMode(android.view.WindowManager.LayoutParams.SOFT_INPUT_ADJUST_RESIZE);
        getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_STABLE);
        // Em aparelhos com câmera/recorte na tela (notch ou furo), sem isso o
        // Android reserva uma faixa em volta do recorte com a cor padrão do
        // sistema (cinza) em vez da cor do app — aparecia como uma faixa
        // cinza cortando a tela, no modo paisagem, perto da borda onde fica
        // esse recorte. Isso manda o conteúdo desenhar por baixo do recorte
        // também nas bordas curtas (o app já tem as barras de status/
        // navegação coloridas com a cor de fundo dele, então cobre certinho).
